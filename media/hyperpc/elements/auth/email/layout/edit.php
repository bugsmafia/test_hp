...
<div id="hp-modal-edit-email" uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
        <button class="uk-modal-close-default" type="button" uk-close></button>
        <h2 class="uk-modal-title">
            <?= Text::_('HYPER_ELEMENT_AUTH_EMAIL_EDIT_ACCOUNT_FORM_TITLE') ?>
        </h2>
        <form class="jsEditFirstStep" data-element-type="<?= $this->getType() ?>">
            <div class="uk-margin">
                <div class="uk-margin-small uk-text-muted">
                    <?= Text::_('HYPER_ELEMENT_AUTH_EMAIL_EDIT_ACCOUNT_FORM_ENTER_NEW_EMAIL') ?>
                </div>
                <div class="uk-inline uk-width-1-1">
                    <span class="uk-form-icon uk-icon" uk-icon="icon: mail"></span>
                    <input type="email" placeholder="my@new.email" name="email" class="uk-input hpJsEditValue" required />
                </div>
                <div class="edit-form-error"></div>
            </div>
            ...
            <div class="uk-margin-small uk-text-small uk-text-muted uk-text-center">
                <?= Text::_('COM_HYPERPC_AUTH_CONFIRM_CODE_INFO') ?>
            </div>
