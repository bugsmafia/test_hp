...
/**
 * Class JFormFieldRelatedParts
 *
 * @since   2.0
 */
class JFormFieldRelatedParts extends FormField
{
     ...
     * @since   2.0
     */
    protected $layout = 'joomla.form.field.related_parts';
    ...
    protected function getInput()
    {
        ...
        $this->hyper['helper']['assets']
            ->js('js:widget/fields/related-parts.js')
            ->widget('.jsRelatedParts', 'HyperPC.FieldRelatedParts', [
                'fieldName'    => $this->name,
