...
class HyperPcViewMoysklad_Product extends ViewLegacy
{
    ...
    {
        ToolbarHelper::apply('moysklad_product.apply');
        ToolbarHelper::save('moysklad_product.save');
        ...
        ToolbarHelper::cancel('moysklad_product.cancel');

        ToolbarHelper::title(Text::sprintf('COM_HYPERPC_VIEW_PRODUCT_EDIT_TITLE', $this->item->name, $this->item->sale_price->text()), 'puzzle');
