...
class HyperPcViewMoysklad_Part extends ViewLegacy
{
    ...
    {
        ToolbarHelper::apply('moysklad_part.apply');
        ToolbarHelper::save('moysklad_part.save');
        ...
        ToolbarHelper::cancel('moysklad_part.cancel');

        ToolbarHelper::title(Text::sprintf('COM_HYPERPC_VIEW_PARTS_EDIT_TITLE', $this->item->name, $this->item->sale_price->text()), 'puzzle');
