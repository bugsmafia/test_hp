 ...
 * @since       2.0
 */
class HyperPcViewStore extends ViewLegacy
{
    ...
    protected function _addToolbar()
    {
        ...
        if ($this->item->id !== 0) {
            ToolbarHelper::title(Text::sprintf('COM_HYPERPC_VIEW_STORE_EDIT_TITLE', $this->item->name), 'database');
        } else {
            ToolbarHelper::title(Text::_('COM_HYPERPC_VIEW_STORE_ADD_NEW_TITLE'), 'database');
        }
