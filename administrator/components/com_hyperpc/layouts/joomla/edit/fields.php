 ...
 * @var         HyperPcViewPart $displayData
 */
...
if (array_key_exists('jparams', $fieldSets)) {
    unset($fieldSets['jparams']);
}

if (array_key_exists('jmetadata', $fieldSets)) {
    unset($fieldSets['jmetadata']);
}
