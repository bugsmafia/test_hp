 ...
 * @since       2.0
 */
class HyperPcTableStatuses extends Table
{

    /**
     * HyperPcTableStatuses constructor.
     *
    ...
    public function __construct(\JDatabaseDriver $db)
    {
            ...
            if ($commonDb->connected()) {
                ...
                trigger_error(
                    Text::sprintf(
                        ...
                        HP_DB_COMMON . ' ' . HP_TABLE_STATUSES
                    ),
                    E_USER_NOTICE
                );
            }
        ...
        parent::__construct(HP_TABLE_STATUSES, HP_TABLE_PRIMARY_KEY, $db);
    }
}
