 ...
 * @since       2.0
 */
class HyperPcTableWorkers extends Table
{

    /**
     * HyperPcTableWorkers constructor.
     *
    ...
    public function __construct(\JDatabaseDriver $db)
    {
        ...
        parent::__construct(HP_TABLE_WORKERS, HP_TABLE_PRIMARY_KEY, $db);
    }
}
