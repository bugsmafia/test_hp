...
namespace HYPERPC\MoySklad\Client\Product;

use HYPERPC\MoySklad\Entity\Product\Bundle;
...
use MoySklad\Client\BundleClient as BundleClientBase;

class BundleClient extends BundleClientBase
{
    use
