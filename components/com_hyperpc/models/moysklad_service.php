 ...
 * @since   2.0
 */
class HyperPcModelMoysklad_Service extends ModelAdmin
{
    ...
    {
        $this->setHelper($this->hyper['helper']['moyskladService']);
    ...
    public function save($data)
    {
        ...
        try {
            ...
            $servicesTable->load($positionsTable->id);

            if (empty($servicesTable->id)) {
                $data['id'] = $positionsTable->id;
            }

            if (!$this->_saveDataToTable($servicesTable, $data)) {
                return false;
            }
