 ...
 * @since   2.0
 */
class HyperPcModelMoysklad_Part extends ModelAdmin
{
    ...
    {
        $this->setHelper($this->hyper['helper']['moyskladPart']);
    ...
    public function save($data)
    {
        ...
        try {
            ...
            $partsTable->load($positionsTable->id);

            if (empty($partsTable->id)) {
                $data['id'] = $positionsTable->id;
            }

            if (!$this->_saveDataToTable($partsTable, $data)) {
                return false;
            }
