            ...
            <div class="uk-grid" uk-height-viewport="expand: true">
                <div class="hp-step-configurator__aside">
                    ...
                    <div class="hp-step-configurator__aside-content">
                        ...
                        <ul class="uk-list uk-list-bullet">
                            ...
                            <li class="jsComplectationSummary" hidden>
                                <div class="tm-text-medium uk-text-emphasis">
                ...
                <div class="hp-step-configurator__main uk-width-expand">
                    <ul class="jsStepConfiguratorSwitcher uk-switcher">
                        ...
                        <li></li>
                        <li class="uk-active">
                            <?php foreach ($this->platformState as $key => $sectionData) :
                                $sectionTitle = $this->platform[$key]['title'];
                                ?>
                                <div class="jsPlatformParamsSection uk-margin-medium" data-prop="<?= $key ?>">
                                    <div class="uk-h4 uk-text-normal uk-margin-small-bottom"><?= $sectionTitle ?></div>
                                    <div>
                                        <div class="uk-grid uk-grid-collapse uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-3@l uk-child-width-1-4@xl">
                                            <?php foreach ($sectionData as $buttonKey => $buttonData) :
                                                $class = ['hp-step-configurator__button-platform', 'uk-button'];
                                                $icon = 'plus-circle';
                                                if ($buttonData['isActive']) {
                                                    $class[] = 'uk-button-primary';
                                                    $icon = 'check';
                                                } elseif ($buttonData['isDisabled']) {
                                                ...
                                                ?>
                                                <div>
                                                    <button class="<?= implode(' ', $class) ?>" data-value="<?= $buttonKey ?>">
                                                        <span class="uk-icon uk-flex-none" uk-icon="icon:<?= $icon ?>" data-ratio="1.25"></span>
                                                        <span>
                                                            <span><?= $buttonKey ?></span>
                                                            <?php if (!empty($buttonData['subline'])) : ?>
                                                                <br />
